"""
Django settings for emergency_alerts_41559 project.
...
ROOT_URLCONF = 'emergency_alerts_41559.urls'
...
WSGI_APPLICATION = 'emergency_alerts_41559.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "emergency_alerts_41559 API",
    "DESCRIPTION": "API documentation for emergency_alerts_41559 App",
    "VERSION": "v1",
}
